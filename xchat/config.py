...
class TorConfig:
    ...
    message_cache_file: str = str(Path.home() / ".local" / "share" / "xchat" / "messages.json")
    ...
    def from_env(cls) -> "TorConfig":
        ...
        return cls(
            ...
            message_cache_file=os.environ.get(
                "XCHAT_MESSAGE_CACHE_FILE", str(Path.home() / ".local" / "share" / "xchat" / "messages.json")
            ),
        )
